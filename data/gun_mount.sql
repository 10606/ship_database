...
insert into gun_mount 
    ...
    /* 76.2mm/40 AA gun */
    (42,  null,                              null,          34, 1, 30), /*Конго x16 [16.08.13 1918]
    ...
    ( 5, 'тип A',                           'type A',        1, 1, 55), /*Сирацую Хацухару*/
    ...
    ( 9, 'тип B2 (с закрытым щитом)',       'type B2',      20, 1, 75), /*Укуру
                                                                          ...
                                                                          Мая []*/
    /* 127mm type 89 AA */
    (10, 'тип B1 мод 4 (с щитом)',          'type B1 mod 4',22, 1, 90), /*Мацу */
    (11, 'тип A (без щитов)',               'type A',       22, 2, 90), /*Мацу ...*/
    (12, 'тип A мод 1 (с закрытым щитом)',  'type A mod 1', 22, 2, 90), /*Меко Такао Атаго Мая Могами* Тоне* */
    (13, 'тип A мод 1 (с щитом)',           'type A mod 1', 22, 2, 90), /*Кага
                                                                          Секаку 
                                                                          Нагато 
                                                                          Титосе 
                                                                          Конго x4 .32
                                                                          ...*/
    (69, 'тип A мод 2 (закрытая)',          'type A mod 2', 22, 2, 90), /*Кага*/
    ...
    (64, 'тип A (казематный)',              'type A',        2, 1, 30), /*Исе  Хюга*/
...
insert into gun_mount 
    ...
    (68,  null,                              null,          10, 1, null), /*Кумано Мару*/
