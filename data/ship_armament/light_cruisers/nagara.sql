...
insert into ship_event_list
    ...
    (0, 19, '1931-12-01', '1932-02-29', 'Сасебо'), /* неточная дата окончания */
    (1, 19, '1932-10-01', '1933-01-20', 'Сасебо'), /* неточная дата начала */
    (0, 19, '1933-05-15', '1934-01-15', 'Сасебо'),
    (0, 19, '1935-10-19', '1936-03-31', 'Сасебо, перевод котлов на мазут'),
    (1, 19, '1936-06-11', '1936-09-30', 'Сасебо'), /* неточная дата окончания */
    (1, 19, '1937-09-15', '1937-09-28', 'Сасебо'),
    (0, 19, '1940-10-15', '1941-01-30', 'Майдзуру'),
    ...
    (0, 20, '1931-05-15', '1931-09-30', 'Йокосука'), /* неточная дата окончания */
    ...
    (0, 20, '1934-10-30', '1935-01-15', 'Куре, модернизация радиооборудования, перевод котлов на мазут'),
    ...
    (0, 21, '1935-10-14', '1936-06-15', 'Сасебо, перевод котлов на мазут'),
    (0, 21, '1936-06-09', '1937-03-20', 'Сасебо'),
    ...
    (0, 22, '1934-10-01', '1935-01-31', 'Сасебо, перевод котлов на мазут'), /* неточные даты */
    (1, 22, '1936-06-10', '1937-03-31', 'Сасебо'), /* неточная дата окончания */
    ...
    (0, 23, '1935-10-19', '1936-03-31', 'Сасебо, перевод котлов на мазут'), /* неточная дата окончания */
    ...
    (0, 24, '1935-10-11', '1936-05-31', 'Куре'),
    (0, 24, '1937-10-09', '1938-01-31', 'Куре'), /* неточная дата начала */
...
insert into ship_guns
    (ship_id, mount_id, amount, date_from, date_to)
    values
    (19, 55,  2, '1922-04-21', '1933-05-15'),
    (19, 50,  2, '1922-04-21', '1933-05-15'),
    (19, 49,  2, '1934-01-15', '1940-10-15'),
    (19, 52,  2, '1934-01-15', '1940-10-15'),
    (19, 53,  1, '1934-01-15', '1942-04-12'),
    (19, 52,  2, '1942-04-24', '1944-08-07'),
    (19, 44,  2, '1941-01-30', '1943-08-20'),
    ...
    (21, 55,  2, '1922-09-15', '1936-06-09'),
    (21, 50,  2, '1922-09-15', '1931-07-27'),
    (21, 53,  1, '1932-09-30', '1936-06-09'),
    (21, 49,  2, '1932-09-30', '1939-12-01'),
    (21, 52,  2, '1937-03-20', '1939-12-01'),
    (21, 47,  2, '1937-03-20', '1943-06-02'),
    ...
    (22, 53,  1, '1934-01-25', '1942-10-25'),
    (22, 52,  2, '1934-01-25', '1937-11-22'),
    ...
    (24, 49,  2, '1934-08-31', '1937-10-09'),
    (24, 53,  1, '1934-08-31', '1944-10-26'),
    (24, 52,  2, '1934-08-31', '1935-10-11'),
    (24, 44,  2, '1936-05-31', '1944-10-26'),
...
insert into ship_throwers
    ...
    (21, 2, 2, '1922-09-15', '1939-12-01'),
    (21, 0, 1, '1940-04-01', '1944-08-19'),
...
insert into ship_searchers
    (ship_id, searcher_id, amount, date_from, date_to)
    values
    (19, 36, 3, '1922-04-21', '1940-10-15'),
    (19, 30, 3, '1941-01-30', '1944-08-07'),

    (20, 36, 3, '1923-08-15', '1938-03-01'),
    (20, 30, 3, '1939-01-31', '1944-05-01'),
    (20, 30, 2, '1944-09-14', '1945-04-07'),

    (21, 36, 3, '1922-09-15', '1931-07-27'),
    (21, 36, 4, '1932-09-30', '1939-12-01'),
    (21, 30, 3, '1940-04-01', '1944-08-19'),

    (22, 36, 3, '1923-03-20', '1937-11-22'),
    (22, 30, 3, '1938-04-08', '1942-10-25'),
    
    (23, 36, 3, '1925-05-26', '1932-12-10'),
    (23, 36, 4, '1933-03-15', '1937-04-15'),
    (23, 30, 3, '1938-02-25', '1944-10-26'),

    (24, 36, 3, '1922-11-10', '1937-10-09'),
...
insert into ship_catapult
    ...
    values
    (19, 2, 1, '1922-04-21', '1931-12-01'),
    (19, 8, 1, '1934-01-15', '1944-01-26'),

    (20, 2, 1, '1923-08-15', '1932-09-24'),
...
insert into ship_aircraft
    ...
    values
    (19,  41, 2, '1934-01-15', '1940-10-15'), /* E4N2 */ /* в 1936 в Китае имел 2 самолета */
    (19,  31, 1, '1941-01-30', '1944-01-26'), /* E7K2 */

    (20,  41, 1, '1934-02-17', '1934-10-30'), /* E4N2 */
    (20,  30, 1, '1935-01-15', '1938-03-01'), /* E7K1 */
    ...
    (22, 143, 1, '1932-01-01', '1933-06-13'), /* E3A1 */ /* неточные даты */
    (22,  41, 1, '1934-01-25', '1937-11-22'), /* E4N2 */
    (22,  30, 1, '1938-04-08', '1942-10-25'), /* E7K1 */

    (23,  41, 1, '1933-03-15', '1935-10-19'), /* E4N2 */
    (23,  30, 1, '1936-03-31', '1941-01-01'), /* E7K1 */
    (23,  31, 1, '1941-06-30', '1944-03-01'), /* E7K2 */

    (24, 143, 1, '1932-01-01', '1934-02-02'), /* E3A1 */ /* неточные даты */
    (24,  41, 1, '1934-08-31', '1935-05-07'), /* E4N2 */
    (24,  30, 1, '1935-05-07', '1944-10-26'); /* E7K1 */
