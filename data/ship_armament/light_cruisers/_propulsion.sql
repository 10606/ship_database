...
insert into steam_turbine
    ...
    (27, 'Гихон высокого давления',                 'Gihon high pressure',               null,  null,   null, 6 /* +5 */),  /* 4* Нагара, Исудзу, Натори, Юра, Абукума, 
                                                                                                                               4* Сендай, Нака */
    (28, 'Мицубиси-Парсон низкого давления',        'Mitsubishi-Parson low pressure',    null,  null,   null, 2),           /* 4* Нагара, Исудзу, Натори, Юра, Абукума,
                                                                                                                               4* Сендай, Нака */
...
insert into steam_turbine_cruise
    ...
    (31, 'Гихон-Мицубиси',  'Gihon-Mitsubishi',  null,  null,   null, 2), /* 2* Нагара, Исудзу, Натори, Юра, Абукума,
                                                                             2* Сендай, Нака */
...
insert into steam_turbine_reverse
    ...
    (33, 'Мицубиси-Парсон', 'Mitsubishi-Parson', null,  null,   null, 1), /* 4* Нагара, Исудзу, Натори, Юра, Абукума,
                                                                             4* Сендай, Нака */
...
insert into boiling_types
    ...
    (10, 'Кампон Ро Го',    'Kampon Ro Go',     2,  100,    18.3, null), /* 12* Оои, 
...
insert into external_burn_boiling
    ...
    ( 6,  8,  6), /* Оедо */
    ( 7,  9,  6), /* тип Агано */
    ( 8, 10, 12), /* Нагара, Исудзу, Натори, Юра, Абукума, 
                     Сендай, Нака */
    ( 9, 11, 12), /* Кину, Дзинцу */
    (10, 10, 12); /* Оои */
