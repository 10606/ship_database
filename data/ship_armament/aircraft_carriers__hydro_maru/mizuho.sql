...
insert into ship_aircraft
    ...
    values
    (81, 31, 22, 2, '1939-02-25', '1941-09-20'), /* E7K2 */ /* неточная длата окончания */
    (81, 31,  3, 0, '1941-09-30', '1942-05-01'), /* E7K2 */ /* неточная длата начала */
    (81, 37, 12, 0, '1941-09-30', '1942-05-01'); /* F1M */  /* неточная длата начала */
