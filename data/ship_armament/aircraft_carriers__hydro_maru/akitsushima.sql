...
insert into general
    ...
    values
    (83, '1942-04-29', '1944-09-24',    4725, 5080,   114.8, 15.8, 5.4,    338 /* по другим данным 545 */, 19, 14, 15000);
...
insert into ship_aircraft
    ...
    values
    (83, 35, 1, 0, '1942-04-29', '1944-09-24'); /* H6K */ /* неточная модель */
