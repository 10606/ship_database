...
/*
    143 - Муцуки    | Mutsuki   | 1926-03-25   | 1942-08-25 | авиацией, Соломоновы острова
    144 - Кисараги  | Kisaragi  | 1925-12-21   | 1941-12-11 | Уэйк
    145 - Яей       | Yayoi     | 1926-08-28   | 1942-09-11 | авиацией, у Новой Британии
    146 - Удзуки    | Uzuki     | 1926-09-14   | 1944-12-12 | у острова Себу
    147 - Сацуки    | Satsuki   | 1925-11-15   | 1944-09-21 | Манильская бухта
    148 - Минадзуки | Minazuki  | 1927-03-22   | 1944-06-06 | торпедирован SS-257 Harder, море Сулавеси
    149 - Фумидзуки | Fumizuki  | 1926-07-03   | 1944-02-18 | Трук
    150 - Нагацуки  | Nagatsuki | 1927-04-30   | 1943-07-06 | сел на мель, сражение в заливе Кула
    151 - Кикудзуки | Kikuzuki  | 1926-11-20   | 1942-05-05 | у острова Тулаги
    152 - Микадзуки | Mikazuki  | 1927-05-05   | 1943-07-29 | сел на мель, мыс Глотчестер
    153 - Мотидзуки | Mochizuki | 1927-10-31   | 1943-10-24 | авиацией, Соломоновы острова
    154 - Юдзуки    | Yuzuki    | 1927-07-25   | 1944-12-12 | авиацией, у острова Себу
*/
...
insert into ship_searchers
    (ship_id, searcher_id, amount, date_from, date_to)
    values
    (143, 36, 1, '1926-03-25', '1942-08-25'),
    (144, 36, 1, '1925-12-21', '1941-12-11'),
    (145, 36, 1, '1926-08-28', '1942-09-11'),
    (146, 36, 1, '1926-09-14', '1943-06-03'),
    (147, 36, 1, '1925-11-15', '1944-09-21'),
    (148, 36, 1, '1927-03-22', '1944-06-06'),
    (149, 36, 1, '1926-07-03', '1944-02-18'),
    (150, 36, 1, '1927-04-30', '1943-07-06'),
    (151, 36, 1, '1926-11-20', '1942-05-05'),
    (152, 36, 1, '1927-05-05', '1943-07-29'),
    (153, 36, 1, '1927-10-31', '1943-10-24'),
    (154, 36, 1, '1927-07-25', '1944-12-12');
...
insert into ship_throwers
    ...
    values
    (143, 1, 2, '1932-09-15', '1937-01-01'), /* неточная модель, у Альпакова тип 88 */
    (143, 0, 2, '1937-02-28', '1942-08-25'),

    (144, 1, 2, '1932-09-15', '1937-01-01'), /* неточная модель, у Альпакова тип 88 */
    (144, 0, 2, '1937-02-28', '1941-12-11'),

    (145, 1, 2, '1932-09-30', '1937-01-01'), /* неточная модель, у Альпакова тип 88 */
    (145, 0, 2, '1937-06-30', '1942-09-11'),
        
    (146, 1, 2, '1932-09-15', '1937-01-01'), /* неточная модель, у Альпакова тип 88 */
    (146, 0, 2, '1937-02-28', '1944-12-12'),

    (147, 1, 2, '1932-09-15', '1938-01-01'), /* неточная модель, у Альпакова тип 88 */
    (147, 0, 2, '1938-12-31', '1944-09-21'),

    (148, 1, 2, '1932-09-15', '1938-01-01'), /* неточная модель, у Альпакова тип 88 */
    (148, 0, 2, '1938-12-31', '1944-06-06'),

    (149, 1, 2, '1932-09-15', '1938-01-01'), /* неточная модель, у Альпакова тип 88 */
    (149, 0, 2, '1938-12-31', '1944-02-18'),

    (150, 1, 2, '1932-09-30', '1938-01-01'), /* неточная модель, у Альпакова тип 88 */
    (150, 0, 2, '1938-12-31', '1943-07-06'),

    (151, 1, 2, '1932-09-30', '1938-01-01'), /* неточная модель, у Альпакова тип 88 */
    (151, 0, 2, '1938-12-31', '1942-05-05'),
        
    (152, 1, 2, '1932-09-30', '1941-01-01'), /* неточная модель, у Альпакова тип 88 */
    (152, 0, 2, '1941-07-31', '1943-07-29'),
        
    (153, 1, 2, '1932-09-30', '1937-01-15'), /* неточная модель, у Альпакова тип 88 */
    (153, 0, 2, '1938-02-28', '1943-10-24'),
        
    (154, 1, 2, '1932-09-30', '1941-01-01'), /* неточная модель, у Альпакова тип 88 */
...
insert into ship_throwers
    (ship_id, throwers_id, amount, date_from, date_to)
    values
    (143, 5, 2, '1932-09-15', '1942-08-25'),
    (144, 5, 2, '1932-09-15', '1941-12-11'),
    (145, 5, 2, '1932-09-30', '1942-09-11'),
    (146, 5, 2, '1932-09-15', '1944-12-12'),
    (147, 5, 2, '1932-09-15', '1944-09-21'),
    (148, 5, 2, '1932-09-15', '1944-06-06'),
    (149, 5, 2, '1932-09-15', '1944-02-18'),
    (150, 5, 2, '1932-09-30', '1943-07-06'),
    (151, 5, 2, '1932-09-30', '1942-05-05'),
    (152, 5, 2, '1932-09-30', '1943-07-29'),
    (153, 5, 2, '1932-09-30', '1943-10-24'),
    (154, 5, 2, '1932-09-30', '1944-12-12');
