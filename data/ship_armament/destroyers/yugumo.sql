...
/*
    224 - Югумо     | Yugumo    | 1941-12-05   | 1943-10-06 
    225 - Макигумо  | Makigumo  | 1942-03-14   | 1943-02-01 
    226 - Кадзaгумо | Kazagumo  | 1942-03-28   | 1944-06-08 
    227 - Наганами  | Naganami  | 1942-06-30   | 1944-11-11 
    228 - Макинами  | Makinami  | 1942-08-08   | 1943-11-25 
    229 - Таканами  | Takanami  | 1942-08-31   | 1942-11-30 
    230 - Онами     | Onami     | 1942-12-29   | 1943-11-25 
    231 - Киенами   | Kiyonami  | 1943-01-25   | 1943-07-20 
    232 - Таманами  | Tamanami  | 1943-04-30   | 1944-07-07 
    233 - Судзунами | Suzunami  | 1943-07-27   | 1943-11-11 
    234 - Фудзинами | Fujinami  | 1943-07-31   | 1944-10-27 
    235 - Хаянами   | Hayanami  | 1943-07-31   | 1944-06-07 
    236 - Хаманами  | Hamanami  | 1943-10-15   | 1944-11-11 
    237 - Окинами   | Okinami   | 1943-12-10   | 1944-11-13 
    238 - Кисинами  | Kishinami | 1943-12-03   | 1944-12-04 
    239 - Асасимо   | Asashimo  | 1943-11-27   | 1945-04-07 
    240 - Хаясимо   | Hayashimo | 1944-02-20   | 1944-10-26 
    241 - Акисимо   | Akishimo  | 1944-03-11   | 1944-11-13 
    242 - Киесимо   | Kiyoshimo | 1944-05-15   | 1944-12-29 
*/
...
insert into general
    ...
    values
    (224, '1941-12-05', '1943-10-06',    2077, 2520,   119.15, 10.8, 3.76,  225, 35.5, 18, 5000),
    (225, '1942-03-14', '1943-02-01',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000),
    (226, '1942-03-28', '1944-06-08',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000),
    (227, '1942-06-30', '1944-11-11',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000),
    (228, '1942-08-08', '1943-11-25',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000),
    (229, '1942-08-31', '1942-11-30',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000),
    (230, '1942-12-29', '1943-11-25',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000),
    (231, '1943-01-25', '1943-07-20',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000),
    (232, '1943-04-30', '1944-07-07',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000),
    (233, '1943-07-27', '1943-11-11',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000),
    (234, '1943-07-31', '1944-10-27',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000),
    (235, '1943-07-31', '1944-06-07',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000),
    (236, '1943-10-15', '1944-11-11',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000),
    (237, '1943-12-10', '1944-11-13',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000),
    (238, '1943-12-03', '1944-12-04',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000),
    (239, '1943-11-27', '1945-04-07',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000),
    (240, '1944-02-20', '1944-10-26',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000),
    (241, '1944-03-11', '1944-11-13',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000),
    (242, '1944-05-15', '1944-12-29',    2077, 2520,   119.15, 10.8, 3.76,  228, 35.5, 18, 5000);
...
insert into ship_searchers
    (ship_id, searcher_id, amount, date_from, date_to)
    values
    (224, 32, 2, '1941-12-05', '1943-10-06'),
    (225, 32, 2, '1942-03-14', '1943-02-01'),
    (226, 32, 2, '1942-03-28', '1944-06-08'),
    (227, 32, 2, '1942-06-30', '1944-11-11'),
    (228, 32, 2, '1942-08-08', '1943-11-25'),
    (229, 32, 2, '1942-08-31', '1942-11-30'),
    (230, 32, 2, '1942-12-29', '1943-11-25'),
    (231, 32, 2, '1943-01-25', '1943-07-20'),
    (232, 32, 2, '1943-04-30', '1944-07-07'),
    (233, 32, 2, '1943-07-27', '1943-11-11'),
    (234, 32, 2, '1943-07-31', '1944-10-27'),
    (235, 32, 2, '1943-07-31', '1944-06-07'),
    (236, 32, 2, '1943-10-15', '1944-11-11'),
    (237, 32, 2, '1943-12-10', '1944-11-13'),
    (238, 32, 2, '1943-12-03', '1944-12-04'),
    (239, 32, 2, '1943-11-27', '1945-04-07'),
    (240, 32, 2, '1944-02-20', '1944-10-26'),
    (241, 32, 2, '1944-03-11', '1944-11-13'),
    (242, 32, 2, '1944-05-15', '1944-12-29');
