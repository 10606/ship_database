...
insert into external_burn_list
    ...
    (32,  null,  52000,  null), /* тип Тайе */ /* по другим данным 25200л.с., при этом параметры котлов и турбин не указаны */
    (33,  null,  31117,  null), /* Хосе */
    (34,  null,  56250,  null), /* Дзюнье */
    (35,  null,  56630,  null); /* Хие */
...
insert into external_burn_machines
    ...
    /* Дзюнье */
    /* 
        по данным Альпакова Дзюнье имел 
            4 турбины высокого давления Мицубиси
            4 турбины среднего давления с крейсерской ступенью Мицубиси
            4 турбины низкого давления с крейсерской ступенью Мицубиси
    */
    (34, 83, 2),
    (34, 84, 2),
    (34, 85, 4),
    ...
    /* Хие */
    /* по данным Альпакова к турбины Хие назывались Кертис */
    (35, 83, 2),
    (35, 84, 2),
    (35, 85, 4);
...
insert into ship_propulsion
    ...
    /* Хосе */
    (56, 33, 1, '1922-12-27', '1944-06-19'),

    /* тип Дзюнье */
    (67, 34, 1, '1942-05-03',  null),
    (68, 35, 1, '1942-07-31', '1944-06-20');
