...
insert into general
    ...
    (8, '1936-01-31', '1944-06-27',     39130, 42850,   224.94,  34.6,  9.5,    1368, 24.98, 16, 14000),
    (8, '1944-06-27',  null,            39130, 43581,   224.94,  34.6,  9.5,    1368, 24.98, 16, 14000),
    
    (9, '1921-11-22', '1934-09-05',     32720, 38500,   215.8,   28.95, 9.14,   1333, 26.2,  16,  8850),
    (9, '1936-09-30', '1943-06-08',     39130, 42850,   224.94,  34.6,  9.5,    1368, 25.0,  16, 14000);
...
insert into ship_event_list
    ...
    (1, 9, '1923-11-30', '1923-12-30', 'Сасебо'),
...
insert into ship_guns
    ...
    (9, 55,  4, '1921-11-22', '1927-01-20'), /* неточные даты */
    (9, 55,  7, '1927-05-27', '1932-02-27'),
    (9, 58,  4, '1921-11-22', '1932-02-27'),
    (9, 52,  4, '1932-02-27', '1939-01-31'),
    (9, 13,  4, '1933-01-30', '1943-06-08'),
    (9, 48,  2, '1933-01-30', '1938-12-15'),
    (9, 44, 10, '1939-01-31', '1943-06-08');
...
insert into ship_torpedo_tubes
    ...
    (9,  1, 2, '1921-11-22', '1927-01-20'); /* неточные даты */
...
insert into ship_searchers
    ...
    (9, 36,  2, '1933-01-30', '1943-06-08'),
    (9, 30,  4, '1933-01-30', '1943-06-08');
...
insert into ship_catapult
    ...
    values
    (8,  3, 1, '1925-08-01', '1927-09-01'), /* неточные даты, на картинках в июле 1927 присутствует, в октябре 1927 отсутствует */ /* на башне No 2 */
    (8,  8, 1, '1933-07-31', '1937-09-01'), /* неточные даты */
    (8, 10, 1, '1937-11-30', '1945-06-01'), /* неточная дата начала */ /* по другим данным с 1940 */

    (9,  3, 1, '1927-05-27', '1932-02-27'),
    (9,  8, 1, '1933-01-30', '1934-09-05'),
    (9, 10, 1, '1936-09-30', '1943-06-08');
...
insert into ship_aircraft
    ...
    (9, 72, 1, '1927-05-27', '1932-02-27'), /* E1Y2 */
    ...
    (9, 37, 2, '1943-02-06', '1943-06-08'); /* F1M2 */
