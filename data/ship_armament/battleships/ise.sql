...
insert into ship_event_list
    ...
    (0, 6, '1928-01-01', '1929-02-28', 'Куре, установка дымоотвода на носовую трубу'), /* неточные даты */
    ...
    (8, 7, '1927-05-01', '1927-06-30', 'перестроена надстройка, установлен дымоотвод на носовую трубу'), /* неточные даты */
...
insert into ship_guns
    (ship_id, mount_id, amount, date_from, date_to)
    values
    (6, 15, 20, '1917-12-15', '1931-11-20'),
    (6, 15, 18, '1932-02-10', '1934-09-25'),
    (6, 64, 16, '1937-03-23', '1943-02-23'),
    
    (7, 15, 20, '1918-04-30', '1933-01-01'),
    (7, 15, 18, '1933-05-31', '1934-10-24'),
...
insert into ship_torpedo_tubes
    ...
    values
    (6, 25, 6, '1917-12-15', '1934-09-25'),
    (7, 25, 6, '1918-04-30', '1934-10-24');
