...
insert into ship_event_list
    ...
    (7, 11, '1944-03-29', '1944-03-29', 'торпедирован SS-282 Tunny, принял 2630 тонн воды'),
...
insert into ship_guns
    ...
    (11, 40, 3, '1942-06-01', '1944-10-24'); /* неточная дата начала */
...
insert into ship_guns
    ...
    (11, 24, 4, '1942-06-01', '1944-04-10'), /* неточная дата начала */
...
insert into ship_guns
    ...
    (10, 46,  8, '1941-12-16', '1943-07-12'),
    (10, 52,  2, '1941-12-16', '1945-04-07'),
    (10, 46, 12, '1943-07-16', '1944-02-25'), /* неточное соотношение открытых(45) / закрытых(46) установок 25 тип 96 */
    (10, 46, 20, '1944-03-18', '1945-04-07'), /* неточное соотношение открытых(45) / закрытых(46) установок 25 тип 96 */
    (10, 43, 26, '1944-03-18', '1944-11-25'),
    (10, 45,  5, '1944-07-08', '1944-11-25'),
    (10, 45, 30, '1945-01-03', '1945-04-07'),
    (10, 43,  2, '1945-01-03', '1945-04-07'),
    
    (11, 14,  6, '1942-06-01', '1944-10-24'), /* неточная дата начала */
    (11, 13,  6, '1944-04-27', '1944-10-24'),
    (11, 46,  8, '1942-06-01', '1942-06-27'), /* неточная дата начала */
    (11, 52,  2, '1942-06-01', '1944-10-24'), /* неточная дата начала */
    (11, 46, 12, '1942-07-23', '1944-10-24'), /* неточное соотношение открытых(45) / закрытых(46) установок 25 тип 96 */
    (11, 45, 18, '1944-04-27', '1944-07-02'), /* 14 директоров тип 95 */
    (11, 45, 23, '1944-07-08', '1944-10-24'),
...
insert into ship_searchers
    ...
    (11,  1, 2, '1944-04-27', '1944-07-02'), /* тип 22 мод 2 */
...
insert into ship_searchers
    ...
    (11, 31, 8, '1942-06-01', '1944-04-10'), /* неточная дата начала */
...
insert into ship_catapult
    ...
    (11, 11, 2, '1942-06-01', '1944-10-24'); /* неточная дата начала */
