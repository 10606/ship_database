...
insert into gun_list
    ...
    (34,'тип 41',       '3rd year type',    76.2,40, 0, 13,      5400,   2400, null,    '1897-01-01'),
...
insert into gun_list
    ...
    (14, 'тип 11',              'type 11',                   75, 34,    1, null,  6600,   2000,     44, '1922-01-01'),
    (42, 'тип 41',              '3rd year type',            76.2,40,    1,   13,  5400,   2400,   null, '1916-01-01'), /* вариант 76.2мм тип 41 (3rd year type) */
    (15, 'тип 88',              'type 88',                  76.2,44,    1,   15,  9000,   2450,   2000, '1928-01-01'),
...
insert into gun_list
    ...
    (46, 'Schwazlose',                      'Schwazlose',               6.5, 81.5,  2,  500, null,  19.9,   null,   null), /* Конго, тип Фусо */
    ...
    (35, 'тип 89 (энергия отдачи)',         'type 89 (fixed)',          7.7, 78,    2,  800,  null, 12.7,   null,   null), /*Ki-27 Ki-43 Ki-44 Ki-30 Ki-51 Ki-32 Te-Ke (type 97)*/ /* Vickers */
